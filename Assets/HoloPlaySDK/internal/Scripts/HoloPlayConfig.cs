...
namespace HoloPlaySDK
{
    ...
    public class HoloPlayConfig
    {
        ...
        public ConfigValue pitch = new ConfigValue(101.36f, 1f, 200, "Pitch");
        public ConfigValue slope = new ConfigValue(6, -30, 30, "Slope");
        public ConfigValue center = new ConfigValue(0, -1, 1, "Center");
        public ConfigValue viewCone = new ConfigValue(45, -180, 180, "View Cone");
        public ConfigValue verticalAngle = new ConfigValue(0, -20, 20, "Vert Angle");
        public ConfigValue numViews = new ConfigValue(22, 2, 128, "Num Views", true);
        public ConfigValue DPI = new ConfigValue(265, 1, 1000, "DPI", true);
