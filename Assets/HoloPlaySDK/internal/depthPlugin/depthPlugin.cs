...
namespace HoloPlaySDK
{
    ...
    public class depthPlugin : MonoBehaviour
    {
        ...
        /// <summary>
        /// Should we expect any data at all?
        /// </summary>
        ...
        {
			if (pluginThread == null || !pluginThread.prepareTouches()) //do this first.  if it gives false it means the plugin isn't even loaded.
                return;
